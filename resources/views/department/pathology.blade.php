...
@section('content')
    <h1  class="has-text-centered is-size-4 has-text-weight-semibold">PATHOLOGY DEPARTMENT</h1>
   
   
    <form action="pathologystore" class="column is-half is-offset-3" method="post">
        @csrf
